...
//   ros2 run elite_robots_driver example_moveit_pose_goal --ros-args -p offset:="[0.02,0.0,0.0]"
//
//   # Execute the plan:
//   ros2 run elite_robots_driver example_moveit_pose_goal --ros-args -p execute:=true -p offset:="[0.02,0.0,0.0]"
//
