...
```bash
ros2 run eli_cs_robot_driver example_moveit_pose_goal_py \
...
```bash
ros2 launch eli_cs_robot_driver example_safe_joint_move.launch.py \
  cpp_py:=cpp \
...
```bash
ros2 launch eli_cs_robot_driver example_forward_velocity_controller.launch.py
```
